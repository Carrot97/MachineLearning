...
import numpy as np
import time
from tensorflow.exsamples.tutorials.mnist import input_data
mnist = input_data.read_data_sets('MNIST_data', one_hot=True)

def batch(data, label, batch_size):
    indexs = [i for i in range(0, len(label))]
...
for i in range(10001):
    batch_train_x, batch_train_y = batch(mnist.train.images, mnist.train.labels, 300)
