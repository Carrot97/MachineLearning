...
def smoSimple(dataMatIn, classLabels, C, toler, maxiter_num):
    # 转换为numpy的mat存储
...
if __name__ == '__main__':
    dataMat, labelMat = loaddataset('linear_dataset.txt')
    b, alphas = smoSimple(dataMat, labelMat, 0.6, 0.001, 200)
