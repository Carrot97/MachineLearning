...
if __name__ == '__main__':
    ...
    sup_vec_x = train_data[sup_vec_index]
    sup_vec_y = train_labels[sup_vec_index]
    ...
    for i in range(m):
        kernelEval = kernel_cal(sup_vec_x, test_data[i, :], 1.3)
        predict = kernelEval.T * np.multiply(sup_vec_y, alphas[sup_vec_index]) + b
